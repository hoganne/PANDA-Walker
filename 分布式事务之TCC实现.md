...
## **TCC 的基本概念** [#][http://www.tianshouzhi.com/api/tutorials/distributed_transaction/388]
...
首先说一下，这里可能会牵扯到一些 Spring Cloud 的原理

咱们先来看看业务场景，假设你现在有一个电商系统，里面有一个支付订单的场景。

![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124221344003-1003664855.png)
...
## 进一步思考[#](https://www.cnblogs.com/jajian/p/10014145.html#进一步思考)
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124221516538-2117168183.png)
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124221639782-279567864.png)

## 落地实现 TCC 分布式事务[#](https://www.cnblogs.com/jajian/p/10014145.html#落地实现-tcc-分布式事务)

那么现在到底要如何来实现一个 TCC (try-comfirm-cancel)分布式事务，使得各个服务，要么一起成功？要么一起失败呢？

咱们就以一个 Spring Cloud 开发系统作为背景来解释。

### TCC 实现阶段一：Try[#](https://www.cnblogs.com/jajian/p/10014145.html#tcc-实现阶段一：try)
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124231758883-311791121.png)

## TCC 实现阶段二：Confirm[#](https://www.cnblogs.com/jajian/p/10014145.html#tcc-实现阶段二：confirm)
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124232142806-1339085171.png)

## TCC 实现阶段三：Cancel[#](https://www.cnblogs.com/jajian/p/10014145.html#tcc-实现阶段三：cancel)
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124232236571-484288052.png)

## 总结与思考[#](https://www.cnblogs.com/jajian/p/10014145.html#总结与思考)

基本上大家应该都知道 TCC 分布式事务具体是怎么回事了！
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124232434414-110430781.png)
...
## 最终一致性分布式事务如何保障实际生产中 99.99% 高可用？[#](https://www.cnblogs.com/jajian/p/10014145.html#最终一致性分布式事务如何保障实际生产中-9999-高可用？)
...
![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124232543507-80796570.png)

大家看上图，如果不考虑各种高并发、高可用等技术挑战的话，单从“可靠消息”以及“最终一致性”两个角度来考虑，这种分布式事务方案还是比较简单的。

## 可靠消息最终一致性方案的核心流程[#](https://www.cnblogs.com/jajian/p/10014145.html#可靠消息最终一致性方案的核心流程)

### ①上游服务投递消息[#](https://www.cnblogs.com/jajian/p/10014145.html#①上游服务投递消息)
...
### ②下游服务接收消息[#](https://www.cnblogs.com/jajian/p/10014145.html#②下游服务接收消息)

下游服务就一直等着从 MQ 消费消息好了，如果消费到了消息，那么就操作自己本地数据库。

如果操作成功了，就反过来通知可靠消息服务，说自己处理成功了，然后可靠消息服务就会把消息的状态设置为“已完成”。

### ③如何保证上游服务对消息的 100% 可靠投递？[#](https://www.cnblogs.com/jajian/p/10014145.html#③如何保证上游服务对消息的-100-可靠投递？)
...
### ④如何保证下游服务对消息的 100% 可靠接收？[#](https://www.cnblogs.com/jajian/p/10014145.html#④如何保证下游服务对消息的-100-可靠接收？)
...
### ⑤如何基于 RocketMQ 来实现可靠消息最终一致性方案？[#](https://www.cnblogs.com/jajian/p/10014145.html#⑤如何基于-rocketmq-来实现可靠消息最终一致性方案？)
...
## 可靠消息最终一致性方案的高可用保障生产实践[#](https://www.cnblogs.com/jajian/p/10014145.html#可靠消息最终一致性方案的高可用保障生产实践)

### 背景引入[#](https://www.cnblogs.com/jajian/p/10014145.html#背景引入)
...
### 基于 KV 存储的队列支持的高可用降级方案[#](https://www.cnblogs.com/jajian/p/10014145.html#基于-kv-存储的队列支持的高可用降级方案)

大家来看看下面这张图，这是我曾经指导过朋友的一个公司针对可靠消息最终一致性方案设计的一套高可用保障降级机制。

这套机制不算太复杂，可以非常简单有效的保证那位朋友公司的高可用保障场景，一旦 MQ 中间件出现故障，立马自动降级为备用方案。

![img](https://img2018.cnblogs.com/blog/1162587/201811/1162587-20181124232927245-945975189.png)

### ①自行封装 MQ 客户端组件与故障感知[#](https://www.cnblogs.com/jajian/p/10014145.html#①自行封装-mq-客户端组件与故障感知)
...
### ②基于 KV 存储中队列的降级方案[#](https://www.cnblogs.com/jajian/p/10014145.html#②基于-kv-存储中队列的降级方案)
...
### ③下游服务消费 MQ 的降级感知[#](https://www.cnblogs.com/jajian/p/10014145.html#③下游服务消费-mq-的降级感知)
...
### ④故障的自动恢复[#](https://www.cnblogs.com/jajian/p/10014145.html#④故障的自动恢复)
...
### ⑤更多的业务细节[#](https://www.cnblogs.com/jajian/p/10014145.html#⑤更多的业务细节)
